...
# Encoding the dependent variable into Purchased
...
# Fitting a Naive Bayes Classifier to the Training set and predicting the Test set
library(e1071)
classifier= naiveBayes(x=trainSet[-3],
                       y =trainSet$Purchased)

#Predicting Purchased
